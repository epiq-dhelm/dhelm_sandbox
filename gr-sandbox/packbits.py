...
class packbits(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "packbits")
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.qtgui_time_sink_x_0_1, 0))
...
def main(top_block_cls=packbits, options=None):
